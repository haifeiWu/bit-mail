...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.ProfilePhoto = field.NewField(tableName, "profile_photo")
...
type user struct {
	...
	ProfilePhoto field.Field
	CreatedAt    field.Time
	UpdatedAt    field.Time
	Gender       field.Int32 // 1：男，2：女
	Status       field.Int32 // 1：正常用户，2：非正常用户
...
func (u *user) updateTableName(table string) *user {
	...
	u.ProfilePhoto = field.NewField(table, "profile_photo")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["profile_photo"] = u.ProfilePhoto
