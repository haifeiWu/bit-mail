...
func newContact(db *gorm.DB, opts ...gen.DOOption) contact {
	...
	_contact.UserID = field.NewInt32(tableName, "user_id")
	_contact.ContactName = field.NewString(tableName, "contact_name")
	_contact.ContactEmail = field.NewString(tableName, "contact_email")
...
func (c *contact) updateTableName(table string) *contact {
	...
	c.ContactEmail = field.NewString(table, "contact_email")
...
func (c *contact) fillFieldMap() {
	...
	c.fieldMap["contact_email"] = c.ContactEmail
